 ...
 * 
 * @author Li,Bingwei
 * @date Aug 17, 20121:32:12 PM adwoadmin Arith
 * 
 */
public class Arith {
	...
	public static void main(String[] args) {
		...
		System.out.println((int) sub(l, s));
		System.out.println((int) div(l, s));

		System.out.println("v="
				+ Arith.sub(Arith.sub(9850324.2, 548632.2), 25463.2));

		System.out.println(Arith.div(19, 5));
